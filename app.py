...
T = {
    ...
    "ar": {
        ...
        "warning": (
            ...
            "تُظهر حالة الانهيار ما قد يحدث عند هبوط حاد يشمل السوق كله فتنخفض معظم الأسهم معاً، "
            "ومع ذلك يبقى هبوطٌ أكبر ممكناً دائماً. استرشد بهذه الأرقام، ولا تعدّها ضماناً."
        ),
